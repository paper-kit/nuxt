<template>
  <div>
    <h1 class="text-xl font-bold mb-4">List</h1>
    <p class="mb-4">
      Here is the full list. More icons will be added periodically, and you may
      also request new icons at the issue tracker.
    </p>
    <div>
      <PUInput
        v-model="searchTerm"
    ...
    <div class="grid grid-cols-6 gap-4">
      ...
      >
        <PUIcon :name="icon" class="text-2xl mb-2" />
